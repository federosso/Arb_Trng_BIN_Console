...
//$my_coin_list = array("USDT"=>50, "XRP"=>250); // currency => amount
//**************************************************************************************************************** */
...
// Be careful, use $Sim_Bal = 1 feature if you have no money on your trading account and want to run tests 
// or when $validate = 1 or $validate = 2
...
//$validate = 2; // I use real data but orders are simulated (the output is only for tests to run the program)
//**************************************************************************************************************** */
...
//$min_profit = 3; // ABOVE THIS VALUE ENTERS THE MARKET (high risk of losing money)
$min_profit = 5; // ABOVE THIS VALUE ENTERS THE MARKET (real chance of profit but it rarely happens)
